...
const MIN_STAT_VALUE = 0  # Changed minimum to 0
const MAX_STAT_VALUE = 20
const BASE_STAT_VALUE = 0  # Changed from 10 to 0 - players start with zero stats
...
# Race modifiers - updated according to requirements
var race_modifiers = {
    "Human": {
        "name": "Human",
